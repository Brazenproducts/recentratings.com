...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Your Yotpo and Judge.me reviews deserve more visibility. RecentRatings puts them on a neutral, indexed page — with fraud dispute and embed widget. $29.99/mo.',
